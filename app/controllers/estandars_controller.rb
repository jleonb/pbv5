class EstandarsController < ApplicationController
  ...
  private
    ...
    def estandar_params
      params.require(:estandar).permit(:n_contrato, :categoria, :caluga, :nombre, :descripcion, :img1, :img2, :img3, :img4, :img5, :direccion, :telefono, :correo, :mapa, :facebook, :twitter, :instagram, :contacto, :web)
    end
end
