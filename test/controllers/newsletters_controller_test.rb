...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { img: @newsletter.img, n_contrato: @newsletter.n_contrato, video: @newsletter.video }
    end
  ...
  test "should update newsletter" do
    patch :update, id: @newsletter, newsletter: { img: @newsletter.img, n_contrato: @newsletter.n_contrato, video: @newsletter.video }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
